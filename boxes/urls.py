...
urlpatterns = [
    ...
    path("picklists/<int:pk>/packages/table", is_staff(picklist_show_table), name="picklist_show_table"),
    ...
    path("reports/<int:pk>/csv", is_staff(report_view_csv), name="report_generate_csv"),
