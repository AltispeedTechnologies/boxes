# Generated by Django 4.2.9 on 2024-02-24 15:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_state', models.PositiveSmallIntegerField(choices=[(1, 'Checked in'), (0, 'Received'), (3, 'Mis-placed'), (2, 'Checked out')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.PositiveSmallIntegerField(choices=[(1, 'Checked in'), (0, 'Received'), (3, 'Mis-placed'), (2, 'Checked out')])),
