# Generated by Django 4.2.9 on 2024-02-26 22:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_state', models.PositiveSmallIntegerField(choices=[(1, 'Checked in'), (2, 'Checked out'), (3, 'Mis-placed'), (0, 'Received')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.PositiveSmallIntegerField(choices=[(1, 'Checked in'), (2, 'Checked out'), (3, 'Mis-placed'), (0, 'Received')])),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('package_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='boxes.package')),
