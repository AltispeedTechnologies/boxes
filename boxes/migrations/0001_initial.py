# Generated by Django 4.2.9 on 2024-03-22 18:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_state', models.PositiveSmallIntegerField(choices=[(0, 'Received'), (3, 'Mis-placed'), (2, 'Checked out'), (1, 'Checked in')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.PositiveSmallIntegerField(choices=[(0, 'Received'), (3, 'Mis-placed'), (2, 'Checked out'), (1, 'Checked in')])),
